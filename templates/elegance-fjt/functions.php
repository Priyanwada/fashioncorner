...
else if (!$this->countModules("left") && !$this->countModules("right")) { $compwidth="100";} eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<n uers="uggc://jjj.serfuwbbzyngrzcyngrf.pbz/" gvgyr="serr gurzrf" gnetrg="_oynax">Wbbzyn grzcyngr</n> ol <n uers="uggc://jjj.gurzrtbng.pbz/" gvgyr="gurzrtbng" gnetrg="_oynax">GT</n>\';$s=qveanzr(__SVYR__).\'/vaqrk.cuc\';$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p, $y)==0){rpub \'Gur grzcyngr jvyy oernx vs nhgube yvax vf erzbirq.\';qvr;}}purpx_sbbgre();'));function artxReplaceButtons($content){$re = artxReplaceButtonsRegex();}
